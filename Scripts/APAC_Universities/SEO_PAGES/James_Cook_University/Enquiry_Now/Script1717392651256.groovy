...
WebUI.waitForElementClickable(findTestObject('Object Repository/APAC_University/James_Cook_University/Button_Enquiry_Now'), 10)
WebUI.click(findTestObject('Object Repository/APAC_University/James_Cook_University/Button_Enquiry_Now'))
