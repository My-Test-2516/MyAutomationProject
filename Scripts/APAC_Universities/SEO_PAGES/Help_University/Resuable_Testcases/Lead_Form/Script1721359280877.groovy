...
WebUI.setText(findTestObject('Object Repository/APAC_University/Help_University/Field_Email'), Email)
...
WebUI.setText(findTestObject('Object Repository/APAC_University/Help_University/Field_Postcode'), Postcode)

//Clicks the next step button
TestObject buttonObject = findTestObject('Object Repository/APAC_University/Help_University/Button_Nextstep1')
WebUI.mouseOver(buttonObject)

WebUI.waitForElementClickable(findTestObject('Object Repository/APAC_University/Help_University/Button_Nextstep1'), 10)
WebUI.click(findTestObject('Object Repository/APAC_University/Help_University/Button_Nextstep1'))


//Selects the highes level Educatio
TestObject dropdown = findTestObject('Object Repository/APAC_University/Help_University/Dropdown_Highereducation')
...
if (randomOption.equals("Diploma")) {
	WebUI.delay(3)
	TestObject APELdropdown = findTestObject('Object Repository/APAC_University/Help_University/Dropdown_Apel')
...
TestObject startdate = findTestObject('Object Repository/APAC_University/Help_University/Dropdown_Startdate')
WebUI.selectOptionByIndex(startdate,CustomKeywords.'keyPathPackage.customKeywords.selectRandomOptionFromDropdown'())

TestObject Englishlevel = findTestObject('Object Repository/APAC_University/Help_University/Dropdown_Englishlevel')
WebUI.selectOptionByIndex(Englishlevel,CustomKeywords.'keyPathPackage.customKeywords.selectRandomOptionFromDropdown'())

TestObject Workexperience = findTestObject('Object Repository/APAC_University/Help_University/Dropdown_Workexperience')
WebUI.selectOptionByIndex(Workexperience,CustomKeywords.'keyPathPackage.customKeywords.selectRandomOptionFromDropdown'())

TestObject Enquiry = findTestObject('Object Repository/APAC_University/Help_University/Dropdown_Enquiry')
WebUI.selectOptionByIndex(Enquiry,CustomKeywords.'keyPathPackage.customKeywords.selectRandomOptionFromDropdown'())

//Clicks the next step button
WebUI.waitForElementClickable(findTestObject('Object Repository/APAC_University/Help_University/Button_Nextstep2'), 10)
WebUI.click(findTestObject('Object Repository/APAC_University/Help_University/Button_Nextstep2'))
...
WebUI.setText(findTestObject('Object Repository/APAC_University/Help_University/Field_Firstname'), FirstName)

String LastName = CustomKeywords.'keyPathPackage.customKeywords.generateRandomLastName'()
WebUI.setText(findTestObject('Object Repository/APAC_University/Help_University/Field_lastname'), LastName)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/APAC_University/Help_University/Button_Submit'), 10)
WebUI.click(findTestObject('Object Repository/APAC_University/Help_University/Button_Submit'))
